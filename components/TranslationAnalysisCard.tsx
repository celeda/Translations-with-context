...
export const TranslationAnalysisCard: React.FC<TranslationAnalysisCardProps> = ({ files, translationKey, onUpdateValue, context: parentContext, onUpdateContext, globalContext, onUpdateGlossary, translationHistory, showFilePreview = false }) => {
    ...
    <div className="flex-grow flex flex-col bg-gray-800/50 rounded-lg overflow-hidden h-full">
      <div className="p-4 border-b border-gray-700 flex flex-col space-y-4">
        ...
        <div className="flex items-end justify-between gap-4">
            <div>
                <label htmlFor={`ai-model-${translationKey}`} className="block text-sm font-medium text-gray-300 mb-2">
                    AI Model
                </label>
                <select
                    id={`ai-model-${translationKey}`}
